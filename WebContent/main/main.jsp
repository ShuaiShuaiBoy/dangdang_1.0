	...
	<body>
		...
		<div class="book">
			...
			<div id="left" class="book_left">
				<s:action name="categoryList" namespace="/category" executeResult="true"/>
			</div>
			<!--左栏结束-->
			...
			<div class="book_center">
				...
				<div class=second_c_border1 id="recommend">
					<s:action name="bookGrooms" namespace="/book" executeResult="true"/>                                                                                                                                                                                                                                                                                                                                                                                                                            
				</div>
				...
				<div class="book_c_border2" id="hot">
					<s:action name="bookFire" namespace="/book" executeResult="true"/>
				</div>
				<!--热销图书结束-->

				<!--最新上架图书开始-->
				<div class="book_c_border2" id="new">
					<s:action name="bookNew" namespace="/book" executeResult="true"/>
				</div>
			...
			<div class="book_right">
				<div class="book_r_border2" id="__XinShuReMai">
					<div class="book_r_b2_1x" id="new_bang">
						<s:action name="bookNewFire" namespace="/book" executeResult="true"/>
					</div>
				</div>
			</div>
			<!--右栏结束-->
