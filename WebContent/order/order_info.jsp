	...
	<body>
		...
		<div class="fill_message">
			...
			<table class="tab_login">
				...
				<!-- 订单开始 -->
				<s:iterator value="#session.cart.items" status="s">
				...
				<tr>
					<td valign="top" class="w1" style="text-align: left" colspan="5">
						<b>总价￥<s:property value="#session.cart.totalNumber"/></b>
					</td>
				</tr>
			</table>
			<br />
			...
			<div class="login_in">
				...
				<a href="../order/address_form.jsp"><input id="btnClientRegister" class="button_1" name="submit"
